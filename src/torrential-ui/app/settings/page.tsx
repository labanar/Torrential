...
function GeneralSettings() {
  ...
  const fetchFilesettings = useCallback(async () => {
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/settings/file`
      );
  ...
  const saveFileSettings = useCallback(async (values) => {
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/settings/file`,
        {
  ...
  const fetchConnectionSettings = useCallback(async () => {
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/settings/connection`
      );
      const json = await response.json();
      console.log(json);
      const {
  ...
  const saveConnectionSettings = useCallback(async (values) => {
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/settings/connection`,
        {
  ...
  const fetchTcpListenerSettings = useCallback(async () => {
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/settings/tcp`
      );
      const json = await response.json();
      console.log(json);
  ...
  const saveTcpSettings = useCallback(async (values) => {
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/settings/tcp`,
        {
